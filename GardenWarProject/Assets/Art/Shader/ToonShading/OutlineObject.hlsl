...
{
	//Getting the values to offset corners of our sampling
	...
	//Offsetting UV Sampling corners by our outline's thickness
	...
	//Calculating if the outline should be drawn depending on the pixel matrix's depth value difference
